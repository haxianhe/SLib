...
if [[ "$(uname)" == "Darwin" ]]; then
    PLIST_PATH="$HOME/Library/LaunchAgents/com.slib.searxng.plist"
...
<dict>
    <key>Label</key>
    <string>com.slib.searxng</string>
...
echo "[2/2] 检查 superpowers（brainstorming skill）..."
