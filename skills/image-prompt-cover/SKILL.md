...
| `elegant` | 米白 + 香槟金 + 深咖,低饱和奶油质地 | 奢华商业、奢侈品类 |
...
| `pastel` | 樱花粉/天蓝/薄荷 | 轻盈柔和、亲子、轻量教育 |
| `mono` | 单色调,纯黑白灰 | 极简、严肃、新闻报道 |
| `retro` | 70s/80s 色,芥末黄/砖红/孔雀蓝 | 怀旧、复古杂志风 |
| `duotone` | 双色调,只用 2 种主色 + 1 中性 | 海报、强海报视觉、品牌头图 |
...
| Rendering | 看起来像 | 用在哪 |
|---|---|---|
| `flat-vector` | 扁平矢量,无阴影/渐变,纯色块 | 扁平品牌、SaaS、产品页 |
...
| 值 | 看起来像 | 用在哪 |
|---|---|---|
| `subtle` | 低对比,温柔静谧 | 静谧、抒情、reflective |
